...
using StackOverdflowProject.CustomFilters;

namespace StackOverdflowProject.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginViewModel lvm)
        {
            if (ModelState.IsValid)
            {
                UserViewModel uvm = this.us.GetUsersByEmailAndPasswordd(lvm.Email, lvm.Password);
                if (uvm != null)
                {
        ...
        public ActionResult ChangeProfile(EditUserDetailsViewModel eudvm)
        {
            ...
            {
                ModelState.AddModelError("x", "Invalod data");
                return View(eudvm);
            }
        }
