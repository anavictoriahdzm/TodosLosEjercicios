...
namespace TopTenPops
{
    class PopulationFormatter
    {
        ...
        //Rounds the population to 4 significate figures
        ...
        public static int RoundToNearest(int exact, int accurancy)
        {
            int adjusted = exact + accurancy / 2;
            return adjusted - adjusted % accurancy;
